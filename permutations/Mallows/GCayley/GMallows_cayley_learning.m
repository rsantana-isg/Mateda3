function[model] = GMallows_cayley_learning(k,NumbVar,Card,SelPop,AuxFunVal,learning_params)
% [model] = GMallows_cayley_learning(k,NumbVar,Card,SelPop,AuxFunVal,learning_params)
% GMallows_cayley_learning:  Creates Generalized Mallows permutation model with cayley distance
%             
% INPUTS
...
Theta =  CalculateThetaParameterGC(ConsensusRanking,SelPop,initialTheta,upperTheta,maxit);

% 3.- Calculate psi constants.
Psis = CalculatePsiConstantsGC(Theta, NSel);
