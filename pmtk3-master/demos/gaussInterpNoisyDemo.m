...
%{
% In this method, the prior precision
% has no effect on the posterior mean, which is probably a bug.
...
printPmtkFigure(sprintf('gaussInterpNoisyDemo%s', filenames{trial}))
