% EXAMPLE 4  Optimization of problems with permutation-based representation:  
% Application of  Mallows EDA using the Cayley distance
% to the the QAP problem
% By commenting some of the lines examples of the application of the
% algorithm to other three problems (PFSP, LOP, TSP) can be obtained.
...
% Last version 06/12/2016. Roberto Santana (roberto.santana@ehu.es) 
 ...
 %ReadLOPInstance('Cebe.lop.n10.1');
 ReadQAPInstance('Cebe.qap.n30.1');
 ...
 edaparams{2} = {'learning_method','Mallows_cayley_learning',{-10.001,10,100,'setMedianPermutation'}};          % Parameters of the learning algorithm
 edaparams{3} = {'sampling_method','Mallows_cayley_sampling',{PopSize-1,1}};                                    % Parameters of the sampling algorithm
