 % EXAMPLE 1  Optimization of problems with permutation-based representation:  
 % Application of Mallows EDA using the Ulam distance
 % to the the PFSP problem
 % By commenting some of the lines examples of the application of the
 % algorithm to other three problems (LOP, QAP, TSP) can be obtained.
 


 global PFSPInstance   % The selected PFSP instance is saved in the global variable PFSPInstance
