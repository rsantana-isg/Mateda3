% EXAMPLE 5  Optimization of problems with permutation-based representation:  
% Application of Mallows EDA using the Kendall distance
% to the the TSP problem
% By commenting some of the lines examples of the application of the
% algorithm to other three problems (PFSP, QAP, LOP) can be obtained.
...
% Last version 06/12/2016. Roberto Santana (roberto.santana@ehu.es) 
 ...
 global TSPInstance   % The selected TSP instance is saved in the global variable TSPInstance

 
 %ReadPFSPInstance('Cebe.pfsp.n30.m10.1');
 %ReadLOPInstance('Cebe.lop.n30.1');
 %ReadQAPInstance('Cebe.qap.n10.1');
 ReadTSPInstance('Cebe.tsp.n30.1');
 ...
 F = 'EvalTSP';               % Optimization problem     [It should be modified according to the problem]
 ...
 edaparams{2} = {'learning_method','Mallows_kendall_learning',{-10.001,10,100,'setMedianPermutation'}};          % Parameters of the learning algorithm
 edaparams{3} = {'sampling_method','Mallows_kendall_sampling',{PopSize-1,1}};                                    % Parameters of the sampling algorithm
