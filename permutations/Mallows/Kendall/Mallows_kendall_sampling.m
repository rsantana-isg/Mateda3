function [NewPop] = Mallows_kendall_sampling(NumbVar,model,Card,AuxPop,AuxFunVal,sampling_params)
% [NewPop] = Mallows_kendall_sampling(NumbVar,model,Card,AuxPop,AuxFunVal,sampling_params)
% Mallows_kendall_sampling:  Samples a population of individuals from an Mallows kendal model
%             
% INPUTS
...
for j=1:N,
	% generate samples and calculate likelihood
