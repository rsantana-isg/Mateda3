...
%NewPop=zeros(N,NumbVar); % The new population is initialized to zero
NewPop=-1*ones(N,NumbVar);
 ...
 for i=1:NumberCliques
  ...
  %[i, Cliques(i,:)]
  sizeCliqOther = Cliques(i,2);  % Size of the new added variables
  sizeCliqSolap = Cliques(i,1);  % Size of the overlapping variables
